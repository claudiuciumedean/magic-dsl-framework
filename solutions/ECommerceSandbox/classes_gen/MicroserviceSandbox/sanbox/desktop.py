...
def get_customer_0_By():
    ...
    entity=project(entity, ['id','name','email','password',])
...
def get_item_1():
    ...
    for item in response:
        entity=project(item, ['id','thumbnail','name','description',])
...
@bff.route('/create-order', methods=['POST'])
def create_order_3():
    entity = None
